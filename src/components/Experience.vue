			...
			<div class="flex justify-between mb-10">
				<div class="flex-1 text-xl">
					...
					<p>Introduction to industrial experience and workplace. Probation period in development operation
						start
						by a few challenges of simple backend project. <br /> "E-GYM" simple backend project challenge
						created
						with Laravel that provide CRUD elements with subscription feature. I learned Livewire which
						known as frontend technologies throughout my probation journey and "E-GYM" received a good
						feedback. I have been absorbed into real-industry project after few months so that i can
						experience much more.</p>
				</div>
				<span class="text-violet-900">December 2020 - Mac 2021 (3 months)</span>
			</div>
		</div>
	</section>
</template>